...
int HomeActivity::getMenuItemCount() const {
  int count = 5;  // File Browser, Recents, Wiener Linien, File transfer, Settings
  ...
  auto activateSelection = [this] {
    ...
    switch (indexToMenuItem(menuIndex, hasOpdsServers)) {
      ...
      case HomeMenuItem::OPDS_BROWSER:
        onOpdsBrowserOpen();
        break;
      case HomeMenuItem::WIENER_LINIEN:
        onWienerLinienOpen();
        break;
...
void HomeActivity::render(RenderLock&&) {
  ...
  std::vector<const char*> menuItems = {tr(STR_BROWSE_FILES), tr(STR_MENU_RECENT_BOOKS), tr(STR_WL_TITLE),
...
void HomeActivity::onWienerLinienOpen() { activityManager.goToWienerLinien(); }
